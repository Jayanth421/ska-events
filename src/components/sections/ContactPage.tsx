        ...
        <div className="grid md:grid-cols-5 gap-10">
          ...
          <div className="md:col-span-2 space-y-6">
            {[
              ...
              { icon: <svg viewBox="0 0 20 20" fill="none" className="w-5 h-5" stroke="currentColor" strokeWidth="1.5"><rect x="2" y="4" width="16" height="13" rx="2"/><path d="M2 6l8 5 8-5"/></svg>, label: t("emailUs"), value: "mailto:skaevents.in@gmail.com", href: "mailto:skaevents.in@gmail.com" },
