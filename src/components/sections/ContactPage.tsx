      ...
      <div className="max-w-5xl mx-auto px-4 py-14">
        <div className="grid md:grid-cols-5 gap-10">
          ...
          <div className="md:col-span-2 space-y-6">
            {[
              { icon: <svg viewBox="0 0 20 20" fill="none" className="w-5 h-5" stroke="currentColor" strokeWidth="1.5"><path d="M3 4a1.5 1.5 0 011.5-1.5h1.4a1 1 0 01.97.757l.8 3.2a1 1 0 01-.29.99L6.5 8.5A11 11 0 0011.5 13.5l1.053-1.38a1 1 0 01.99-.29l3.2.8A1 1 0 0117.5 13.6v1.4A1.5 1.5 0 0116 16.5C8.544 16.5 3.5 11.456 3.5 4H3z"/></svg>, label: t("callUs"), value: "+91 98765 43210", href: "tel:+919876543210" },
              { icon: <svg viewBox="0 0 20 20" fill="none" className="w-5 h-5" stroke="currentColor" strokeWidth="1.5"><rect x="2" y="4" width="16" height="13" rx="2"/><path d="M2 6l8 5 8-5"/></svg>, label: t("emailUs"), value: "hello@skaevents.com", href: "mailto:hello@skaevents.com" },
              ...
              { icon: <svg viewBox="0 0 20 20" fill="none" className="w-5 h-5" stroke="currentColor" strokeWidth="1.5"><path d="M3 4a1.5 1.5 0 011.5-1.5h1.4a1 1 0 01.97.757l.8 3.2a1 1 0 01-.29.99L6.5 8.5A11 11 0 0011.5 13.5l1.053-1.38a1 1 0 01.99-.29l3.2.8A1 1 0 0117.5 13.6v1.4A1.5 1.5 0 0116 16.5C8.544 16.5 3.5 11.456 3.5 4H3z"/><circle cx="14" cy="5" r="2.5" className="fill-current opacity-30"/><path d="M14 3v4M12 5h4" strokeLinecap="round"/></svg>, label: "WhatsApp", value: "+91 98765 43210", href: "https://wa.me/919876543210" },
